...
def central_agent(net_params_queues, exp_queues):
    print "**************** inside central_agent fucntion ***************"
        ...
        while True:
            ...
            if epoch % MODEL_SAVE_INTERVAL == 0:
                ...
                testing(epoch, 
                    ...
                    test_log_file)
                print "************** testing fucntion call ******************"

    print "************ end of central_agent function*********************"            

def agent(agent_id, all_cooked_time, all_cooked_bw, net_params_queue, exp_queue):
    print "**************** inside agent fucntion *********************"
...
def main():
    ...
    coordinator.start()
    print "*********** central_agent function started *************"
